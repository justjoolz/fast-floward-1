    ...
    let content = html`
      <page-body title="${this.title}" category="${this.category}" description="${this.description}">
        ...
        <action-card title="DAY 4: Kitty Items Market - Sell Market Item"
            description="Sell kitty item by the signer -> market" 
        ...
        <action-card title="DAY 4: Kitty Items Market - Remove Market Item"
            description="Remove Signers Kitty Item #ID from the Marketplace" 
        ...
        <action-card title="DAY 4: Kitty Items Market - Buy Market Item" 
            description="Buy Market Item #itemID with signers account" 
        ...
        <action-card title="DAY 5: Kitty Items Market - Buy ALL Market Items!" 
            description="Buy All Market Items with signers account" 
            action="kittyItemsMarketBuyAllMarketItems" 
            method="post" 
            fields="signer marketCollectionAddress">
        ...
        <action-card title="DAY 4: Kitty Items Market - Read Sale Collection IDs" 
            description="Read items available in marketplace @ address" 
